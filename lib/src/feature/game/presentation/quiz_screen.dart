                        ...
                        children: [
                              ...
                              children: [
                                  ...
                                  child: Padding(
                                    ...
                                    child: Transform(
                                      transform: Matrix4.rotationY(
                                          pi), // Отражаем по оси Y
                                      alignment: Alignment.center,
                                      child: AppIcon(
                                        asset: IconProvider.confetti
                                            .buildImageUrl(),
                                        width: 134,
                                        height: 169,
                                      ),
                                ...
                                Positioned(
                                  ...
                                  child: Padding(
                                    ...
                                    child: AppIcon(
                                      asset:
                                          IconProvider.confetti.buildImageUrl(),
                                      width: 134,
                                      height: 169,
                                    ),
                                  ),
                                ...
                                AppIcon(
                                  asset: 'assets/images/win panel.png',
                                  width: double.infinity,
                                  height: 247,
                                  fit: BoxFit.fill,
                                ),
                                ...
                                Positioned(
                                    top: 20,
                                    child: GradientText('WIN', fontSize: 72)),
                                Padding(
                          ...
                          if (isLoose == true)
                            Stack(
                              ...
                              children: [
                                AppIcon(
                                  asset: 'assets/images/lose panel.png',
                                  width: double.infinity,
                                  height: 217,
                                  fit: BoxFit.fill,
                                ),
